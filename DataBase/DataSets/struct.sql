...
DROP TABLE IF EXISTS avaliacao_unidade;
...
DROP TABLE IF EXISTS doenca_remedio;
...
DROP TABLE IF EXISTS doenca_paciente;
...
DROP TABLE IF EXISTS calendario_especializacao_medico;
...
DROP TABLE IF EXISTS consulta_disponivel;
...
DROP TABLE IF EXISTS consulta_paciente_reservada;
